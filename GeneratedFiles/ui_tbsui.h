...
public:
    ...
    void setupUi(QDialog *tbsui)
    {
        ...
        lin_IPPort = new QLineEdit(UpdateWdiget);
        lin_IPPort->setObjectName(QStringLiteral("lin_IPPort"));

        gridLayout_6->addWidget(lin_IPPort, 1, 1, 1, 1);
        ...
        gridLayout_6->addWidget(too_Read, 1, 2, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(sli_H->sizePolicy().hasHeightForWidth());
        sli_H->setSizePolicy(sizePolicy4);
        sli_H->setMinimum(6);
        sli_H->setMaximum(72);
        sli_H->setValue(10);
    ...
    void retranslateUi(QDialog *tbsui)
    {
        ...
        label_14->setText(QApplication::translate("tbsui", "IP&&Port:", nullptr));
        lin_IPPort->setText(QApplication::translate("tbsui", "192.168.8.251:5442", nullptr));
        lin_IPPort->setPlaceholderText(QApplication::translate("tbsui", "192.168.1.188:5442", nullptr));
        ...
        gbox_Tuners->setTitle(QApplication::translate("tbsui", "Device List:", nullptr));
